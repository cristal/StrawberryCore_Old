...
CREATE TABLE `characters` (
  ...
  `petSlotUsed` int(11) unsigned DEFAULT NULL,
  PRIMARY KEY (`guid`),
...
CREATE TABLE `character_stats` (
  ...
  `resilience` int(10) unsigned NOT NULL,
  PRIMARY KEY (`guid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `character_tutorial` (
  ...
  `tut7` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`account`)
) ENGINE=InnoDB AUTO_INCREMENT=1157 DEFAULT CHARSET=utf8 COMMENT='Player System';
...
CREATE TABLE `game_event_save` (
  ...
  `next_start` int(10) unsigned NOT NULL,
...
CREATE TABLE `gm_tickets` (
  ...
  PRIMARY KEY (`guid`)
) ENGINE=InnoDB AUTO_INCREMENT=190 DEFAULT CHARSET=utf8 COMMENT='Player System';
...
CREATE TABLE `reserved_name` (
  `name` varchar(12) NOT NULL DEFAULT '',
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Player Reserved Names';
