    ...
    public:
        ...
        ChatCommand* GetCommands() const
        {
            ...
            static ChatCommand debugCommandTable[] =
            {
                ...
                { "opcode",         SEC_ADMINISTRATOR,  false, &HandleDebugOpcodeCommand,             "", NULL },
                { NULL,             0,                  false, NULL,                               "", NULL }
            };
        ...
        static bool HandleDebugSendSetPhaseShiftCommand(ChatHandler* handler, const char* args)
        {
            ...
            handler->GetSession()->SendSetPhaseShift(PhaseShift, MapID, true);
            return true;
        }
        ...
        // -Dvlpr
        static bool HandleDebugOpcodeCommand(ChatHandler* handler, const char* args)
        {
