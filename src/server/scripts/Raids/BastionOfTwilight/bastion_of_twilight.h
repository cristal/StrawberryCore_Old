...
enum Actions
{
    ACTION_THERALION_TAKEOFF,
    ACTION_THERALION_LAND,
    ACTION_VALIONA_TAKEOFF,
    ACTION_VALIONA_LAND,
    ACTION_IGNACIOUS_SUMMON_LEAP,
    ACTION_IGNACIOUS_SUMMON_RUSH,
...
static const Position Positions[4] =
{
    ...
    {5.5615511f,1.1453654f,4.6544651f,0.0000001f},
    {5.5616511f,1.1453654f,4.6541651f,0.0000001f},
};

enum Spells_Destruction
{
    SPELL_DESTRUCTION_MISSILE = 86408,
