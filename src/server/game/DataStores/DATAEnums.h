...
enum AchievementCriteriaTypes
{
    ...
    // 122
    // 123
    ACHIEVEMENT_CRITERIA_TYPE_SPENT_GOLD_GUILD_REPAIRS = 124, // Spend X gold on guildmember repairs.
    ACHIEVEMENT_CRITERIA_TYPE_REACH_GUILD_LEVEL = 125, // Reach guild level X
    ACHIEVEMENT_CRITERIA_TYPE_CRAFT_ITEMS_GUILD = 126, // Craft X items
    ACHIEVEMENT_CRITERIA_TYPE_CATCH_FROM_POOL = 127, // Catch X fish from fishing pools.
    ACHIEVEMENT_CRITERIA_TYPE_BUY_GUILD_BANK_SLOTS = 128, // Purchase the X guild bank tab.
    ACHIEVEMENT_CRITERIA_TYPE_EARN_GUILD_ACHIEVEMENT_POINTS = 129, // Earn X guild achievement points.
    ACHIEVEMENT_CRITERIA_TYPE_WIN_RATED_BATTLEGROUND = 130, // Win X rated battlegrounds.
    // 131 unused
    ACHIEVEMENT_CRITERIA_TYPE_REACH_BG_RATING = 132, // Earn a battleground rating of X.
    ACHIEVEMENT_CRITERIA_TYPE_BUY_GUILD_TABARD = 133, // Create and purchase a guild crest.
    ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_QUESTS_GUILD = 134, // Complete quests
    ACHIEVEMENT_CRITERIA_TYPE_HONORABLE_KILLS_GUILD = 135, // Honorable kills
    ACHIEVEMENT_CRITERIA_TYPE_KILL_CREATURE_TYPE_GUILD = 136, // Kill X critters in a guild.
