...
typedef char const* DBCString;                       //char* DBCStrings[MAX_LOCALE];
...
struct AreaTableEntry
{
    ...
    //uint32 worldStateId;                                  // 24 - worldStateId
    //uint32 unk24;                                         // 25 4.2.0
...
struct ChrRacesEntry
{
    ...
    uint32      expansion;                                  // 20       m_required_expansion    //uint32                                                // 21 (23 for worgens)
    //uint32                                                // 22 4.0.0
    //uint32                                                // 23 4.0.0
};
...
struct DestructibleModelDataEntry
{
    ...
    uint32  RebuildingDisplayId;    //uint32  RebuildingUnk1;
    //uint32  RebuildingUnk2;
    //uint32  RebuildingUnk3;
    //uint32  RebuildingUnk4;
    uint32  SmokeDisplayId;    //uint32  SmokeUnk1;
    //uint32  SmokeUnk2;
    //uint32  SmokeUnk3;
    //uint32  SmokeUnk4;
    //uint32  UnkDisplayid;
...
struct SpellEffectEntry
{
    ...
    float GetDmgMultiplier() const { return DmgMultiplier; }
    float GetEffectMultipleValue() const { return EffectMultipleValue; }
};
...
struct SpellEntry_n //Structure of the true Spell.dbc 
{
    ...
    DBCString SubName;                                      // 22       m_nameSubtext_lang
...
struct SpellEntry
{
    ...
    /* --- Spell Stat System --- */
    uint32 OldEffectApplyAuraName[3];
    /* --- Spell Stat System --- */
    ...
    SpellReagentsEntry const* GetSecondSpellReagents() const;
