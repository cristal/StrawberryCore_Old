...
enum PartyResult
{
    ...
    ERR_VOTE_KICK_REASON_NEEDED             = 27, // Rename this 4.2.0a
...
class WorldSession
{
    ...
    public:
        ...
        void SendSetPhaseShift(uint32 phaseShift, uint32 MapID, bool withoutmap);
        ...
        void SendAccountDataInitialized(uint32 mask);
    ...
    public:                                                 // opcodes handlers
        ...
        // Wintergrasp Battle
        void SendWGInvitePlayerToWar(uint32 BattleId,uint32 ZoneId,uint32 p_time);
        void SendCancelWGInvitePlayerToWar(uint32 BattleId, uint32 ZoneId, uint32 p_time);
        void SendWGQueueInviteResponce(uint32 BattleId,uint32 ZoneId);
        void SendWGEntered(uint32 BattleId);
        void SendWGKickedMessage(uint32 BattleId);
        void HandleWGQueueInviteResponse(WorldPacket &recv_data);
        void HandleWGEntryInviteResponse(WorldPacket &recv_data);
        void HandleWGLeaveQueue(WorldPacket &recv_data);
        void HandleWGJoinBattle(WorldPacket &recv_data);
        void HandleWGLeaveRequest(WorldPacket &recv_data);
    ...
    private:
        ...
        QueryCallback<PreparedQueryResult, CharacterCreateInfo*> m_charCreateCallback;
