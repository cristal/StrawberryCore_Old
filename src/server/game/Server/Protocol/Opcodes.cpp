...
void InitOpcodeTable()
{
    ...
    OPCODE( CMSG_GROUP_CANCEL,                            STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleNULL                     );
    ...
    OPCODE( CMSG_GUILD_CHALLENGE_UPDATE_REQUEST,          STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleNULL                     );
    ...
    OPCODE( SMSG_GUILD_MAX_DAILY_XP,                      STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleServerSide               );
    OPCODE( SMSG_GUILD_XP_UPDATE,                         STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleServerSide               );
    ...
    OPCODE( SMSG_TRAINER_BUY_RESULT,                      STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleServerSide               );
    ...
    OPCODE( CMSG_REQUEST_RATED_BG_INFO,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleNULL                     );
    OPCODE( CMSG_REQUEST_PVP_OPTIONS_ENABLED,             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleNULL                     );
    ...
    OPCODE( CMSG_STABLE_CHANGE_SLOT,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleStableChangeSlot          );
    ...
    OPCODE( SMSG_BATTLEFIELD_STATUS4,                     STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleServerSide               );
    ...
    OPCODE( SMSG_INSPECT_HONOR_STATS,                     STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleServerSide               );
    ...
    OPCODE( SMSG_BATTLEGROUND_PLAYER_POSITIONS,           STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleServerSide               );
    ...
    OPCODE( CMSG_PET_UNLEARN,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleNULL                     );
    ...
    OPCODE( SMSG_GM_TICKET_STATUS_UPDATE,                 STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleServerSide               );
    ...
    OPCODE( CMSG_LFG_SET_NEEDS,                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleNULL                     );
    ...
    OPCODE( CMSG_DECLINE_CHANNEL_INVITE,                  STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleNULL                     );
    ...
    OPCODE( CMSG_BATTLEFIELD_MGR_EXIT_REQUEST,            STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleServerSide               );
    ...
    OPCODE( CMSG_CONNECT_TO_FAILED,                       STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleNULL                     );
    ...
    OPCODE( SMSG_OPEN_LFG_DUNGEON_FINDER,                 STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleServerSide               );
    ...
    OPCODE( CMSG_GUILD_AUTO_DECLINE_INVITATION,           STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleNULL                     );
    OPCODE( CMSG_SET_PRIMARY_TALENT_TREE,                 STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::HandleNULL                     );
