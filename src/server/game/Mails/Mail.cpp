...
MailReceiver::MailReceiver(Player* receiver,uint64 receiver_lowguid) : m_receiver(receiver), m_receiver_lowguid(receiver_lowguid >> 32)
{
...
void MailDraft::SendMailTo(SQLTransaction& trans, MailReceiver const& receiver, MailSender const& sender, MailCheckMask checked, uint32 deliver_delay)
{
    ...
    stmt->setUInt32(++index, (m_money >> 32));
    stmt->setUInt32(++index, (m_COD >> 32));
