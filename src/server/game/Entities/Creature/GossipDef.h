...
#ifndef STRAWBERRYCORE_GOSSIP_H
#define STRAWBERRYCORE_GOSSIP_H
...
class GossipMenu
{
    public:
        ...
        void AddGossipMenuItemData(uint32 menuItemId, uint32 gossipActionMenuId, uint32 gossipActionPoi, uint32 gossipActionScriptId);
