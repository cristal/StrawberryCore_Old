...
#ifndef STRAWBERRYCORE_CREATURE_H
#define STRAWBERRYCORE_CREATURE_H
...
struct CreatureBaseStats
{
    ...
    static CreatureBaseStats const* GetStats(uint32 entry, uint8 level);
};
...
class Creature : public Unit, public GridObject<Creature>
{
    public:
        ...
        void SetRandomTextID(uint32 textid) { m_randomtextid = textid; }
        uint32 GetRandomTextID() { return m_randomtextid; }
    protected:
