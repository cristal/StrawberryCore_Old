...
enum TransferAbortReason
{
    ...
    TRANSFER_ABORT_LOCKED_TO_DIFFERENT_INSTANCE = 0x12,         // 4.2.0.14333
    TRANSFER_ABORT_ALREADY_COMPLETED_ENCOUNTER  = 0x13          // 4.2.0.14333
};
...
enum PlayerLoginQueryIndex
{
    ...
    PLAYER_LOGIN_QUERY_LOADARENASTATS           = 32,
    PLAYER_LOGIN_QUERY_LOADTALENTBRANCHSPECS    = 33,
    PLAYER_LOGIN_QUERY_LOADPETSLOT              = 34,
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        float percvalue1[200]; // Maximum 200 buff.
        float percvalue2[200]; // Maximum 200 buff.
        float percvalue3[200]; // Maximum 200 buff.
        float percvalue4[200]; // Maximum 200 buff.
        float percvalue5[200]; // Maximum 200 buff.
        uint32 SpellId[200]; // Maximum 200 buff.
        int Number;
        ...
        int FindSpellNumber(uint32 spellid) const
        {
            for(int i = 0; i < 201; ++i) // Maximum 200 buff.
        ...
        bool WGBattleBox;
        bool KickedFromWG;
        uint32 WGQueueBoxTimer;
        uint32 WGBattleBoxTimer;
        uint32 WGKickTimer;
        ...
        void LearnTalent(uint32 talentId, uint32 talentRank, bool one);
