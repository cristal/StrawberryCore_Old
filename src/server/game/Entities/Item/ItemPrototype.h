...
enum ItemModType
{
    ITEM_MOD_MANA                     = 0, // Updated for 4.2.0.14333
    ITEM_MOD_HEALTH                   = 1, // Updated for 4.2.0.14333
    ITEM_MOD_AGILITY                  = 2, // Updated for 4.2.0.14333
    ITEM_MOD_STRENGTH                 = 3, // Updated for 4.2.0.14333
    ITEM_MOD_INTELLECT                = 4, // Updated for 4.2.0.14333
    ITEM_MOD_SPIRIT                   = 5, // Updated for 4.2.0.14333
    ITEM_MOD_STAMINA                  = 6, // Updated for 4.2.0.14333
    ITEM_MOD_DEFENSE_SKILL_RATING     = 7, // Updated for 4.2.0.14333
    ITEM_MOD_DODGE_RATING             = 8, // Updated for 4.2.0.14333
    ITEM_MOD_PARRY_RATING             = 9, // Updated for 4.2.0.14333
    ITEM_MOD_BLOCK_RATING             = 10, // Updated for 4.2.0.14333
    ITEM_MOD_HIT_MELEE_RATING         = 11, // Updated for 4.2.0.14333
    ITEM_MOD_HIT_RANGED_RATING        = 12, // Updated for 4.2.0.14333
    ITEM_MOD_HIT_SPELL_RATING         = 13, // Updated for 4.2.0.14333
    ITEM_MOD_CRIT_MELEE_RATING        = 14, // Updated for 4.2.0.14333
    ITEM_MOD_CRIT_RANGED_RATING       = 15, // Updated for 4.2.0.14333
    ITEM_MOD_CRIT_SPELL_RATING        = 16, // Updated for 4.2.0.14333
    ITEM_MOD_HIT_TAKEN_MELEE_RATING   = 17, // Updated for 4.2.0.14333
    ITEM_MOD_HIT_TAKEN_RANGED_RATING  = 18, // Updated for 4.2.0.14333
    ITEM_MOD_HIT_TAKEN_SPELL_RATING   = 19, // Updated for 4.2.0.14333
    ITEM_MOD_CRIT_TAKEN_MELEE_RATING  = 20, // Updated for 4.2.0.14333
    ITEM_MOD_CRIT_TAKEN_RANGED_RATING = 21, // Updated for 4.2.0.14333
    ITEM_MOD_CRIT_TAKEN_SPELL_RATING  = 22, // Updated for 4.2.0.14333
    ITEM_MOD_HASTE_MELEE_RATING       = 23, // Updated for 4.2.0.14333
    ITEM_MOD_HASTE_RANGED_RATING      = 24, // Updated for 4.2.0.14333
    ITEM_MOD_HASTE_SPELL_RATING       = 25, // Updated for 4.2.0.14333
    ITEM_MOD_HIT_RATING               = 26, // Updated for 4.2.0.14333
    ITEM_MOD_CRIT_RATING              = 27, // Updated for 4.2.0.14333
    ITEM_MOD_HIT_TAKEN_RATING         = 28, // Updated for 4.2.0.14333
    ITEM_MOD_CRIT_TAKEN_RATING        = 29, // Updated for 4.2.0.14333
    ITEM_MOD_RESILIENCE_RATING        = 30, // Updated for 4.2.0.14333
    ITEM_MOD_HASTE_RATING             = 31, // Updated for 4.2.0.14333
    ITEM_MOD_EXPERTISE_RATING         = 32, // Updated for 4.2.0.14333
    ITEM_MOD_ATTACK_POWER             = 33, // Updated for 4.2.0.14333
    ITEM_MOD_RANGED_ATTACK_POWER      = 34, // Updated for 4.2.0.14333
    ITEM_MOD_SPELL_HEALING_DONE       = 35, // Updated for 4.2.0.14333
    ITEM_MOD_SPELL_DAMAGE_DONE        = 36, // Updated for 4.2.0.14333
    ITEM_MOD_MANA_REGENERATION        = 37, // Updated for 4.2.0.14333
    ITEM_MOD_ARMOR_PENETRATION_RATING = 38, // Updated for 4.2.0.14333
    ITEM_MOD_SPELL_POWER              = 39, // Updated for 4.2.0.14333
    ITEM_MOD_HEALTH_REGEN             = 46, // NOT SURE for 4.2.0.14333
    ITEM_MOD_SPELL_PENETRATION        = 47, // NOT SURE for 4.2.0.14333
    ITEM_MOD_BLOCK_VALUE              = 48, // NOT SURE for 4.2.0.14333
    ITEM_MOD_MASTERY_RATING           = 49, // NOT SURE for 4.2.0.14333
    ITEM_MOD_EXTRA_ARMOR              = 50, // NOT SURE for 4.2.0.14333
    ITEM_MOD_FIRE_RESISTANCE          = 51, // NOT SURE for 4.2.0.14333
    ITEM_MOD_FROST_RESISTANCE         = 52, // NOT SURE for 4.2.0.14333
    ITEM_MOD_HOLY_RESISTANCE          = 53, // NOT SURE for 4.2.0.14333
    ITEM_MOD_SHADOW_RESISTANCE        = 54, // NOT SURE for 4.2.0.14333
    ITEM_MOD_NATURE_RESISTANCE        = 55, // NOT SURE for 4.2.0.14333
    ITEM_MOD_ARCANE_RESISTANCE        = 56 // NOT SURE for 4.2.0.14333
};
...
struct ItemTemplate
{
    ...
    uint32  MaxCount;                                       // <= 0: no limit
    uint32  Stackable;                                      // 0: not allowed, -1: put in player coin info tab and don't limit stacking (so 1 slot)
    uint32 ContainerSlots;
    uint32 StatsCount;
    _ItemStat ItemStat[MAX_ITEM_PROTO_STATS];
    uint32 ScalingStatDistribution;                         // id from ScalingStatDistribution.dbc
    uint32 ScalingStatValue;                                // mask for selecting column in ScalingStatValues.dbc
    _Damage Damage[MAX_ITEM_PROTO_DAMAGES];                 // TODO: remove it - WHY ? Need some check about that thing
    uint32 Armor;                                           // TODO: remove it - WHY ? Need some check about that thing
    uint32 HolyRes;                                         // TODO: remove it - WHY ? Need some check about that thing
    uint32 FireRes;                                         // TODO: remove it - WHY ? Need some check about that thing
    uint32 NatureRes;                                       // TODO: remove it - WHY ? Need some check about that thing
    uint32 FrostRes;                                        // TODO: remove it - WHY ? Need some check about that thing
    uint32 ShadowRes;                                       // TODO: remove it - WHY ? Need some check about that thing
    uint32 ArcaneRes;                                       // TODO: remove it - WHY ? Need some check about that thing
    uint32 damageType;
    uint32 Delay;
    uint32 AmmoType;
