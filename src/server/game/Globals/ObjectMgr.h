...
#define STRAWBERRY_TRAINER_START_REF      200000
...
class ObjectMgr
{
    ...
    public:
       ...
       CurrencyOnKillEntry const* GetCurrencyOnKillEntry(uint32 id) const
       {
        ...
        bool LoadStrawberryStrings() { return LoadStrawberryStrings("strawberry_string",MIN_STRAWBERRY_STRING_ID,MAX_STRAWBERRY_STRING_ID); }
        void LoadDbScriptStrings();
        void LoadCreatureLevelStats();
        void LoadCreatureLocales();
        void LoadCreatureTemplates();
        void LoadCreatureTemplateAddons();
        void LoadAllCreaturesAddons();
        ...
        CreatureBaseStats const* GetCreatureStats(uint32 entry, uint8 level);
...
//        GraveYardMap        mGraveYardMap;
    ...
    private:
        ...
        CreatureBaseStatsMap m_creatureLevelStatsMap;
