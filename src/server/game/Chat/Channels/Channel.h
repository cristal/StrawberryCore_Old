...
enum ChatNotify // Updated for 4.2.0.14333
{
    CHAT_YOU_CHANGED_NOTICE           = 0x00,// "Changed Channel: [%s]";
    CHAT_YOU_JOINED_NOTICE            = 0x01,//+ "Joined Channel: [%s]"; -- You joined
    CHAT_SUSPENDED_NOTICE             = 0x02,// "%s left channel.";
    ...
    CHAT_PLAYER_NOT_BANNED_NOTICE     = 0x09,//+ "[%s] Player %s is not banned.";
    CHAT_CHANNEL_OWNER_NOTICE         = 0x0A,//+ "[%s] Channel owner is %s.";
    CHAT_NOT_OWNER_NOTICE             = 0x0B,//+ "[%s] You are not the channel owner.";
    CHAT_ANNOUNCEMENTS_ON_NOTICE      = 0x0C,//+ "[%s] Channel announcements enabled by %s.";
    CHAT_ANNOUNCEMENTS_OFF_NOTICE     = 0x0D,//+ "[%s] Channel announcements disabled by %s.";
    CHAT_MODERATION_ON_NOTICE         = 0x0E,//+ "[%s] Channel moderation enabled by %s.";
    CHAT_MODERATION_OFF_NOTICE        = 0x0F,//+ "[%s] Channel moderation disabled by %s.";
    CHAT_MUTED_NOTICE                 = 0x10,//+ "[%s] You do not have permission to speak.";
    CHAT_PLAYER_KICKED_NOTICE         = 0x11,//? "[%s] Player %s kicked by %s.";
    CHAT_PLAYER_BANNED_NOTICE         = 0x12,//? "[%s] Player %s banned by %s.";
    CHAT_PLAYER_UNBANNED_NOTICE       = 0x13,//? "[%s] Player %s unbanned by %s.";
    CHAT_PLAYER_ALREADY_MEMBER_NOTICE = 0x14,//+ "[%s] Player %s is already on the channel.";
    CHAT_INVITE_NOTICE                = 0x15,//+ "%2$s has invited you to join the channel '%1$s'.";
    CHAT_INVITE_WRONG_FACTION_NOTICE  = 0x16,//+ "Target is in the wrong alliance for %s.";
    CHAT_WRONG_FACTION_NOTICE         = 0x17,//+ "Wrong alliance for %s.";
    CHAT_INVALID_NAME_NOTICE          = 0x18,//+ "Invalid channel name";
    CHAT_NOT_MODERATED_NOTICE         = 0x19,//+ "%s is not moderated";
    CHAT_PLAYER_INVITED_NOTICE        = 0x1A,//+ "[%s] You invited %s to join the channel";
    CHAT_PLAYER_INVITE_BANNED_NOTICE  = 0x1B,//+ "[%s] %s has been banned.";
    CHAT_NOT_IN_AREA_NOTICE           = 0x1C,//+ "[%s] You are not in the correct area for this channel."; -- The user is trying to send a chat to a zone specific channel, and they're not physically in that zone.
    CHAT_NOT_IN_LFG_NOTICE            = 0x1D,//+ "[%s] You must be queued in looking for group before joining this channel."; -- The user must be in the looking for group system to join LFG chat channels.
    CHAT_VOICE_ON_NOTICE              = 0x1E,//+ "[%s] Channel voice enabled by %s.";
    CHAT_VOICE_OFF_NOTICE             = 0x1F,//+ "[%s] Channel voice disabled by %s.";
};
