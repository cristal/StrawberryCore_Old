...
#define POST_CATACLYSM_ACCEPTED_CLIENT_BUILD          {14976, 14480, 14333, 13623, 0}
#define POST_PRE_CATACLYSM_ACCEPTED_CLIENT_BUILD      {13205, 13164, 12340, 11723, 11403, 11159, 10571, 10505, 10146, 9947, 8606, 5875, 6005, 0}
...
namespace LogonHelper
{
    bool IsAcceptedClientBuild(int build);
    bool IsPostCataclysmAcceptedClientBuild(int build);
    bool IsPreCataclysmAcceptedClientBuild(int build);
};
