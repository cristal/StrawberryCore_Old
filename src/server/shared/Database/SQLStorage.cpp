...
/*const char CreatureInfosrcfmt[]="iiiiiiiiiisssiiiiiifffiffiifiiiiiiiiiiffiiiiiiiiiiiiiiiiiiiiiiiisiiliiiiiiiliiisi";
const char CreatureInfodstfmt[]="iiiiiiiiiisssibbiiifffiffiifiiiiiiiiiiffiiiiiiiiiiiiiiiiiiiiiiiisiiliiiiiiiliiiii";
